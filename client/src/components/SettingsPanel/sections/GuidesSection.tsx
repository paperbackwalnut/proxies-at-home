...
export function GuidesSection() {
  ...
  const perCardGuideStyle = useSettingsStore(
    (state) => state.perCardGuideStyle
  );
  const setPerCardGuideStyle = useSettingsStore(
    (state) => state.setPerCardGuideStyle
  );
  const guidePlacement = useSettingsStore((state) => state.guidePlacement);
  const setGuidePlacement = useSettingsStore(
    (state) => state.setGuidePlacement
  );
  const cutGuideLengthMm = useSettingsStore((state) => state.cutGuideLengthMm);
  const setCutGuideLengthMm = useSettingsStore(
    (state) => state.setCutGuideLengthMm
  );
  const registrationMarks = useSettingsStore(
    (state) => state.registrationMarks
  );
  const setRegistrationMarks = useSettingsStore(
    (state) => state.setRegistrationMarks
  );
  const registrationMarksPortrait = useSettingsStore(
    (state) => state.registrationMarksPortrait
  );
  ...
  const availableSpace = bleedEdge
    ? cardSpacingMm / 2 + bleedEdgeWidth
    : cardSpacingMm / 2;
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="grid grid-cols-4 gap-2">
          <button
            ...
            className={`aspect-square h-10 p-1 rounded transition-colors flex items-center justify-center ${
          ...
          >
            <svg width="30" height="40" viewBox="0 0 32 40" className="mx-auto">
              ...
              />
              <path
                d="M26,6 L26,12 M26,6 L20,6"
                fill="none"
                stroke={localColor}
                strokeWidth="2"
              />
              <path
                d="M6,34 L6,28 M6,34 L12,34"
                fill="none"
                stroke={localColor}
                strokeWidth="2"
              />
              <path
                d="M26,34 L26,28 M26,34 L20,34"
                fill="none"
                stroke={localColor}
                strokeWidth="2"
              />
          ...
          <div className="space-y-2">
            <div className="grid grid-cols-4 gap-2 pb-2 border-b border-gray-200 dark:border-gray-600">
              {(
                [
                  ...
                  {
                    style: "dashed-corners",
                    title: "Square Corners - Dashed",
                    paths: [
                  ...
                  {
                    style: "solid-squared-rect",
                    title: "Square Full - Solid",
                    rect: { x: 4, y: 4, w: 20, h: 28 },
                  },
                  {
                    style: "dashed-squared-rect",
                    title: "Square Full - Dashed",
                    rect: { x: 4, y: 4, w: 20, h: 28, dash: "4,3" },
                  },
                  {
                    style: "rounded-corners",
                    title: "Rounded Corners - Solid",
                    paths: [
                      { d: "M4,12 Q4,4 12,4" },
                      { d: "M16,4 Q24,4 24,12" },
                      { d: "M4,24 Q4,32 12,32" },
                  ...
                  {
                    style: "dashed-rounded-corners",
                    title: "Rounded Corners - Dashed",
                    paths: [
                  ...
                  {
                    style: "solid-rounded-rect",
                    title: "Rounded Full - Solid",
                    rect: { x: 4, y: 4, w: 20, h: 28, rx: 5 },
                  },
                  {
                    style: "dashed-rounded-rect",
                    title: "Rounded Full - Dashed",
                    rect: { x: 4, y: 4, w: 20, h: 28, rx: 5, dash: "4,3" },
                  },
                ] as Array<{
                ...
                <button
                  ...
                  className={`p-1 rounded transition-colors ${
                    perCardGuideStyle === config.style
                      ? "bg-blue-100 dark:bg-blue-600"
                      : "bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600"
                  }`}
                  title={config.title}
                  ...
                  >
                    ...
                    {config.rect && (
                      <rect
                        ...
                        stroke={localColor}
                        strokeWidth="2"
                        strokeDasharray={config.rect.dash}
                      />
                    )}
                  </svg>
                </button>
            ...
            <div className="flex rounded-lg overflow-hidden border border-gray-300 dark:border-gray-600">
                ...
                onClick={() => {
                  ...
                  if (isRound) {
                    setPerCardGuideStyle(
                      isDashed ? "dashed-rounded-corners" : "rounded-corners"
                    );
                  } else {
                    setPerCardGuideStyle(
                      isDashed ? "dashed-corners" : "corners"
                    );
                  }
                }}
                className={`flex-1 px-3 py-1.5 text-sm font-medium transition-colors ${
                  perCardGuideStyle.includes("corner")
              ...
              <button
                onClick={() => {
                  ...
                  if (isRound) {
                    setPerCardGuideStyle(
                      isDashed ? "dashed-rounded-rect" : "solid-rounded-rect"
                    );
                  } else {
                    setPerCardGuideStyle(
                      isDashed ? "dashed-squared-rect" : "solid-squared-rect"
                    );
                  }
                }}
                className={`flex-1 px-3 py-1.5 text-sm font-medium transition-colors ${
                  perCardGuideStyle.includes("rect")
                    ? "bg-blue-600 text-white"
                    : "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600"
                }`}
              >
            ...
            <div className="flex rounded-lg overflow-hidden border border-gray-300 dark:border-gray-600">
              <button
                onClick={() => {
                  ...
                  if (isCorners) {
                    setPerCardGuideStyle(
                      isRound ? "rounded-corners" : "corners"
                    );
                  } else {
                    setPerCardGuideStyle(
                      isRound ? "solid-rounded-rect" : "solid-squared-rect"
                    );
                  }
                }}
                className={`flex-1 px-3 py-1.5 text-sm font-medium transition-colors ${
                  !perCardGuideStyle.includes("dashed")
                    ? "bg-blue-600 text-white"
                    : "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600"
                }`}
              >
              ...
              <button
                onClick={() => {
                  ...
                  if (isCorners) {
                    setPerCardGuideStyle(
                      isRound ? "dashed-rounded-corners" : "dashed-corners"
                    );
                  } else {
                    setPerCardGuideStyle(
                      isRound ? "dashed-rounded-rect" : "dashed-squared-rect"
                    );
                  }
                }}
                className={`flex-1 px-3 py-1.5 text-sm font-medium transition-colors ${
            ...
            <div className="flex rounded-lg overflow-hidden border border-gray-300 dark:border-gray-600">
              <button
                ...
                className={`flex-1 px-3 py-1.5 text-sm font-medium transition-colors ${
                  !perCardGuideStyle.includes("rounded")
                    ? "bg-blue-600 text-white"
                    : "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600"
                }`}
              >
      ...
      <div>
        ...
        <Select
          ...
          value={cutLineStyle}
          onChange={(e) =>
            setCutLineStyle(e.target.value as "full" | "edges" | "none")
          }
        >
      ...
      <div>
        <div className="mb-2 flex items-center gap-2">
          <Label htmlFor="registrationMarks">Registration Marks</Label>
          <AutoTooltip content="Adds registration marks for print & cut. Silhouette modes work with Silhouette Cameo. Cricut mode outputs Cricut PTC marks for Cricut Maker on letter paper." />
        </div>
        <div className="grid grid-cols-4 gap-2">
          {/* None */}
          <button
          ...
          >
            ...
            <span
              className={`text-xs font-medium ${registrationMarks === "none" ? "text-blue-700 dark:text-blue-300" : "text-gray-600 dark:text-gray-400"}`}
            >
              None
            </span>
          </button>
          ...
          >
            <div className="h-[42px] flex items-center justify-center">
              {registrationMarksPortrait ? (
                ...
                >
                  ...
                  <path
                    d="M34,6 L34,10 M34,6 L30,6"
                    stroke="black"
                    strokeWidth="1.5"
                    fill="none"
                  />
                  <path
                    d="M6,46 L6,42 M6,46 L10,46"
                    stroke="black"
                    strokeWidth="1.5"
                    fill="none"
                  />
                ...
                >
                  ...
                  <rect x="6" y="6" width="4" height="4" fill="black" />
                  <path
                    d="M46,6 L46,10 M46,6 L42,6"
                    stroke="black"
                    strokeWidth="1.5"
                    fill="none"
                  />
                  <path
                    d="M6,34 L6,30 M6,34 L10,34"
                    stroke="black"
                    strokeWidth="1.5"
                    fill="none"
                  />
            ...
            <span
              className={`text-xs font-medium ${registrationMarks === "3" ? "text-blue-700 dark:text-blue-300" : "text-gray-600 dark:text-gray-400"}`}
            >
              3-Point
            </span>
          </button>
          ...
          >
            ...
            <span
              className={`text-xs font-medium ${registrationMarks === "4" ? "text-blue-700 dark:text-blue-300" : "text-gray-600 dark:text-gray-400"}`}
            >
              4-Point
            </span>
          </button>
          ...
          <button
            onClick={() => {
    setRegistrationMarks("cricut");
    const store = useSettingsStore.getState();
    store.setPageSizePreset("Letter");
    // Landscape: swap to 11x8.5
    if (store.pageOrientation !== "landscape") {
        store.swapPageOrientation();
    }
    store.setColumns(4);
    store.setRows(2);
    store.setCardSpacingMm(1);
    store.setBleedEdge(true);
    store.setBleedEdgeWidth(0.5);
    store.setBleedEdgeUnit("mm");
    store.setCardPositionX(0);
    store.setCardPositionY(0);
}}
            className={`p-2 rounded-lg border transition-colors flex flex-col items-center gap-1 ${
              registrationMarks === "cricut"
                ? "bg-blue-50 dark:bg-blue-900/30 border-blue-300 dark:border-blue-600"
                : "bg-gray-50 dark:bg-gray-800 border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700"
            }`}
          >
            <div className="h-[42px] flex items-center justify-center">
              ...
              >
                ...
                />
                {/* Top-left: triangle + L */}
                <polygon points="6,6 6,9 9,9" fill="black" />
                <path
                  d="M9,6 L14,6 M6,9 L6,14"
                  stroke="black"
                  strokeWidth="1.5"
                  fill="none"
                />
                {/* Top-right: triangle + L */}
                <polygon points="34,6 34,9 31,9" fill="black" />
                <path
                  d="M31,6 L26,6 M34,9 L34,14"
                  stroke="black"
                  strokeWidth="1.5"
                  fill="none"
                />
                {/* Bottom-left: triangle + L */}
                <polygon points="6,46 6,43 9,43" fill="black" />
                <path
                  d="M9,46 L14,46 M6,43 L6,38"
                  stroke="black"
                  strokeWidth="1.5"
                  fill="none"
                />
                {/* Bottom-right: triangle + L */}
                <polygon points="34,46 34,43 31,43" fill="black" />
                <path
                  d="M31,46 L26,46 M34,43 L34,38"
                  stroke="black"
                  strokeWidth="1.5"
                  fill="none"
                />
            ...
            <span
              className={`text-xs font-medium ${registrationMarks === "cricut" ? "text-blue-700 dark:text-blue-300" : "text-gray-600 dark:text-gray-400"}`}
            >
              Cricut
            </span>
          </button>
        ...
        {/* Portrait/Landscape toggle - hide for Cricut (always portrait letter) */}
        {registrationMarks !== "none" && registrationMarks !== "cricut" && (
              ...
              {registrationMarks === "cricut" ? (
                <>
                  ...
                  <ul className="space-y-1 text-xs leading-relaxed">
                    <li>
                      • Print on <strong>letter (8.5×11in)</strong> paper
                    </li>
                    <li>
                      • Set print dialog to{" "}
                      <strong>letter, 100% scale, no fit-to-page</strong>
                    </li>
                    <li>
                      • Cards output as <strong>landscape, 4×2 grid</strong> (8
                      cards/sheet)
                    </li>
                    <li>
                      • Use <strong>1mm bleed</strong> for best cut results
                    </li>
                    <li>
                      • Tape laminated paper nubs to short mat edges for sensor
                      clearance
                    </li>
                  </ul>
                </>
                ...
                <>
                  ...
                  <ul className="space-y-1 text-xs leading-relaxed">
                    ...
                    <li>
                      • Registration mark inset: <strong>0.394 in.</strong>{" "}
                      (min)
                    </li>
                  </ul>
                </>
